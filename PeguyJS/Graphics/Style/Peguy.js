(function(global)
{
	...
	STYLE.textColor = 'rgb(240, 240, 240)';

	STYLE.background0 = 'rgb(0, 0, 0)';
	...
	STYLE.backgroundColor = STYLE.background2;

	STYLE.borderColor = 'rgb(120, 120, 120)';
	STYLE.border = 'solid 1px ' + STYLE.borderColor;
	STYLE.iconsColor = 'rgb(251, 190, 0)';

	STYLE.buttonsBackgroundColor = 'rgb(242, 98, 33)';
	STYLE.buttonsBorderColor = 'rgb(242, 98, 33)';
	STYLE.buttonsTextColor = 'rgb(40, 40, 40)';
	STYLE.buttonsFontWeight = 'bold';
	STYLE.buttonsBorder = 'solid 2px ' + STYLE.buttonsBorderColor;
	...
	STYLE.disableButtonsTextColor = 'rgb(240, 240, 240)';
	STYLE.disableButtonsBorder = 'solid 2px ' + STYLE.disableButtonsBorderColor;

	STYLE.inputBorderColor = 'rgb(140, 140, 140)';
	STYLE.inputFocusBorderColor = 'rgb(180, 180, 180)';
	STYLE.inputBackgroundColor = 'rgb(120, 120, 120)';
	STYLE.inputTextColor = 'rgb(255, 255, 255)';

	STYLE.linkColor = 'rgb(180, 180, 180)';

	//// FloatingPanel ////

	STYLE.floatingPanelBorder = 'solid 2px ' + STYLE.borderColor;
	STYLE.floatingPanelBackgroundColor = 'rgb(60, 60, 60)';
	STYLE.floatingPanelBoxShadow = '3px 4px 5px rgba(0, 0, 0, 0.9)';

	//// Accordion ////

	STYLE.accordionHeaderBackgroundColor = 'rgb(100, 100, 100)';

	//// AutoComplete ////

	STYLE.autoCompleteBorder = 'solid 2px ' + STYLE.borderColor;
	STYLE.autoCompleteBackgroundColor = 'rgb(60, 60, 60)';
	STYLE.autoCompleteTruncateMask = 'linear-gradient(to right, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 1) 75%)';
	STYLE.autoCompleteBoxShadow = '3px 4px 5px rgba(0, 0, 0, 0.9)';
	STYLE.autoCompleteSeletedBackgroundColor = 'rgba(255, 255, 255, 0.2)';

	//// Calendrier ////

	STYLE.calendarHoverBorder = 'solid 1px ' + STYLE.borderColor;
	STYLE.calendarHoverBackgroundColor = 'rgb(40, 40, 40)';
	STYLE.calendarArrowsColor = STYLE.iconsColor;
	STYLE.calendarWeekendColor = 'rgb(180, 180, 180)';
	STYLE.calendarWeekendBackgroundColor = 'rgb(60, 60, 60)';
	STYLE.calendarOtherMonthColor = 'rgb(140, 140, 140)';
	STYLE.calendarTodayColor = 'rgb(40, 40, 40)';
	STYLE.calendarTodayBackgroundColor = STYLE.buttonsBackgroundColor;
	STYLE.calendarSelectedColor = 'rgb(40, 40, 40)';
	STYLE.calendarSelectedBackgroundColor = STYLE.iconsColor;
	STYLE.calendarRingRadius = '50%';
	...
	STYLE.blurFrameBorder = 'solid 1px rgb(70, 70, 70)';
	STYLE.blurFrameBackgroundColor = 'rgb(40, 40, 40)';
	STYLE.blurFrameBoxShadow = '3px 4px 5px rgba(0, 0, 0, 0.9)';
	STYLE.blurFrameTitleColor = 'rgb(100, 100, 100)';
	STYLE.blurFrameContentBorder = 'solid 1px rgb(70, 70, 70) !important';

	//// Check box ////

	STYLE.checkBoxBackGroundColor = 'rgb(255, 255, 255)';
	STYLE.checkBoxBorder = '1px rgb(160, 160, 160) solid';

	//// Freeze screen ////

	STYLE.popupFreezeScreenColor = 'rgba(0, 0, 0, 0.6)';
